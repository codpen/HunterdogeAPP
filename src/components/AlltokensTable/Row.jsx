            ...
            <TableCell >
                <Stack direction="row" alignItems="center">
                    ...
                    <VoteWrapper>
                        ...
                        <ButtonYellow onClick={() => downVoteProject( 1, account)} height={'22px'} weight={'700'}  size={'12px'}>
                            VOTE + 2
                        </ButtonYellow>
                        <ButtonGreen onClick={() => downVoteProject( 1, account)} height={'22px'} weight={'700'}  size={'12px'}>
                            VOTE + 1
                        </ButtonGreen>
                    </VoteWrapper>
                    <More>...</More>
